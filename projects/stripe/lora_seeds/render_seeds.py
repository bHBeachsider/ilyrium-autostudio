...
SKID = "a thick dark brown skid-mark stain stripe across the seat of his white speedo"
...
views = {
    ...
    "seed4_rear": f"standing with his back to the viewer, full body rear view, {SKID}, hands at sides",
}
jobs = []
